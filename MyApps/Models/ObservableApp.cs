...
{
    public partial class ObservableApp : ObservableRecipient, IRecipient<CloseMessage>
    {
        ...
        public ObservableApp(Entities.App app)
        {
            ...
            var find = Process.GetProcessesByName(Name).FirstOrDefault();
            if (find != null)
            {
                _process = find;
        ...
        public async void Receive(CloseMessage message)
        {
            if (_process == null)
            {
                return;
